package httpmultiplexer.httpproxy;
...
public class ProxyServlet extends HttpServlet {
     ...
     * the servlet log.
     */
    private static final Logger _logger = LoggerFactory.getLogger(ProxyServlet.class);
    ...
    /**
     * The parameter name for the 2nd target (destination) URI to proxy to.
     */
    protected static final String P_2NDTARGET_URI = "secondTargetUri";
    ...
    /**
     * Duplicate target host to multiplex httprequest
     */
    protected String secondTargetUri;
    protected URI secondTargetUriObj;//new URI(secondTargetUri)
    protected HttpHost secondTargetHost;//URIUtils.extractHost(secondTargetUriObj);
    ...
    public void init() throws ServletException {
        ...
        this.doLog = Config.getParamBoolean("main", "logging", false);
        this.doForwardIP = Config.getParamBoolean("main", "forward_ip", false);
    ...
    public void destroy() {
        ...
        if (proxyClient instanceof Closeable) {//TODO AutoCloseable in Java 1.6
            try {
                ...
                _logger.error("While destroying servlet, shutting down HttpClient: " + e, e);
            }
        } else {
    ...
    protected void service(HttpServletRequest servletRequest, HttpServletResponse servletResponse)
        ...
        try {
            // Execute the request
            if (doLog) {
                _logger.info("proxy " + method + " uri: " + servletRequest.getRequestURI() + " -- " + proxyRequest.getRequestLine().getUri());
            }
    ...
    protected void duplicateRequest(HttpServletRequest servletRequest)
            throws ServletException, IOException {
        //initialize request attributes from caches if unset by a subclass by this point
        if (servletRequest.getAttribute(ATTR_TARGET_URI) == null) {
        ...
        try {
            ...
            _logger.error("proxy " + method + " uri: " + servletRequest.getRequestURI() + " -- " + proxyRequest.getRequestLine().getUri() + " got error " + e.toString());
        } finally {
